        ...
        <div className="min-h-screen bg-[#070a13] text-slate-100 selection:bg-brand-500 selection:text-white relative overflow-hidden">
            ...
            <section className="relative max-w-7xl mx-auto px-6 pt-16 pb-20 text-center">
                ...
                >
                    ...
                    <motion.p 
                        variants={fadeInUp}
                        className="text-lg md:text-xl text-slate-450 text-slate-400 max-w-2xl mx-auto leading-relaxed mb-10"
                    >
                    ...
                    >
                        ...
                        <button 
                            className="w-full sm:w-auto px-8 py-4 rounded-xl bg-slate-900 border border-slate-800 text-slate-350 hover:text-slate-100 hover:bg-slate-800/80 font-semibold transition-all duration-200"
                        >
                            Browse Features
                        </button>
                    </motion.div>
                ...
                <motion.div 
                    ...
                    className="max-w-5xl mx-auto p-2 rounded-3xl bg-slate-900/50 border border-slate-800/80 shadow-premium relative overflow-hidden backdrop-blur-sm"
                >
                    ...
                    <div className="bg-[#0b0f19] rounded-2xl p-6 md:p-8 flex flex-col md:flex-row gap-6 min-h-[400px]">
                        ...
                        <div className="hidden md:flex flex-col gap-4 w-48 border-r border-slate-900 pr-6">
                            <div className="w-24 h-6 rounded-lg bg-slate-800/80 animate-pulse" />
                            <div className="space-y-3 mt-4">
                                <div className="w-full h-9 rounded-xl bg-brand-500/10 border border-brand-500/20" />
                                <div className="w-full h-9 rounded-xl bg-slate-800/40" />
                                <div className="w-full h-9 rounded-xl bg-slate-800/40" />
                            </div>
                        </div>
                        ...
                        <div className="flex-1 space-y-6">
                            ...
                            <div className="flex justify-between items-center">
                                <div className="space-y-1">
                                    ...
                                    <div className="w-32 h-6 rounded-lg bg-slate-850" />
                                </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div className="col-span-2 p-5 rounded-2xl bg-gradient-to-br from-brand-600/90 to-indigo-600/90 text-left relative overflow-hidden">
                                    ...
                                    <h4 className="text-2xl md:text-3xl font-extrabold mt-1 text-white">₹1,45,280</h4>
                                    <div className="mt-6 flex justify-between items-center text-xs text-brand-200">
                                        <span>•••• 5512</span>
                                        <span>VISA</span>
                                    </div>
                                </div>
                                <div className="p-5 rounded-2xl bg-slate-900 border border-slate-800/60 flex flex-col justify-between text-left">
                                    <span className="text-xs text-slate-400 font-semibold">Monthly Budget</span>
                                    <div className="mt-4">
                            ...
                            <div className="space-y-3 text-left">
                                <div className="w-28 h-5 rounded bg-slate-800/80" />
                                <div className="p-3.5 rounded-xl bg-slate-900/60 border border-slate-800/40 flex justify-between items-center">
                                    <div className="flex items-center gap-3">
            ...
            <section className="max-w-7xl mx-auto px-6 py-24 relative z-10 border-t border-slate-900">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    {[
                        ...
                        <div 
                            key={i} 
                            className="p-8 rounded-2xl bg-slate-900/40 border border-slate-800/50 hover:border-slate-800 hover:bg-slate-900/60 transition-all duration-300 group shadow-premium"
                        >
            ...
            <section className="max-w-7xl mx-auto px-6 py-12">
                <div className="relative rounded-[32px] bg-gradient-to-tr from-slate-900 to-brand-950 p-10 md:p-20 text-center border border-slate-800/80 overflow-hidden shadow-premium">
                    ...
                    <div className="relative z-10 max-w-2xl mx-auto">
                        ...
                        <div className="mt-8 flex flex-wrap gap-6 justify-center text-xs text-slate-400">
